            ...
            <div className="px-5 pb-5">
                <a href="/">
                    <h5 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">
                        ...
                        {(themeMode === 'dark') ? ' Apple Watch Series 7 GPS, Aluminium Case, Starlight Sport' : '---- ---- ----- ---- ----'}
                    </h5>
                </a>
                ...
                <div className="flex items-center justify-between">
                    <span className="text-3xl font-bold text-gray-900 dark:text-white">{(themeMode === 'dark') ? '$599' : '----'}</span>
                    <button
